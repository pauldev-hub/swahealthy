"""
Seed data for the SwaHealthy database.
All initial symptoms, conditions, facilities, doctors, and medicines.
"""
...
def seed_data(cursor):
    """Seed symptoms, conditions, condition_symptoms linkages, and facilities."""
    ...
    symptoms = [
        ...
        ("Eye redness", "চোখ লাল হওয়া", "आँखें लाल होना", "head"),
        ("Blurred vision", "ঝাপসা দৃষ্টি", "धुंधली दृष्टि", "head"),
        ("Runny nose", "নাক দিয়ে জল পড়া", "बहती नाक", "head"),
        ...
        ("Body ache", "গায়ে ব্যথা", "बदन दर्द", "general"),
        ...
        ("Loss of smell", "গন্ধ না পাওয়া", "सूंघने की क्षमता में कमी", "general"),
        # Skin (9)
        ("Rash", "র‍্যাশ", "चकत्ते", "skin"),
        ("Itching", "চুলকানি", "खुजली", "skin"),
        ("Yellowing skin", "ত্বক হলুদ হওয়া", "त्वचा का पीला पड़ना", "skin"),
        ("Pale skin", "ফ্যাকাশে ত্বক", "पीली त्वचा", "skin"),
        ("Dry skin", "শুষ্ক ত্বক", "रूखी त्वचा", "skin"),
        ("Swelling", "ফোলা", "सूजन", "skin"),
        ("Bruising", "শিরা ফুলে যাওয়া", "चोट", "skin"),
    ...
    conditions = [
        ...
        ("Food Poisoning", "খাদ্যে বিষক্রিয়া", "भोजन विषाक्तता", "medium",
         ...
         "বমি বন্ধ না হওয়া পর্যন্ত কঠিন খাবার এড়িয়ে চলুন।",
         "उल्टी रुकने तक ठोस भोजन से बचें।",
         1, None),
        ("Typhoid Risk", "টাইফয়েডের ঝুঁকি", "टाइफाइड का जोखिम", "high",
        ...
        ("Tension Headache", "টেনশন মাথাব্যথা", "तनाव सिरदर्द", "low",
         ...
         "বিশ্রাম নিন এবং ঘাড় মাসাজ করুন।",
        ...
        ("Hypertension Risk", "উচ্চ রক্তচাপ ঝুঁকি", "उच्च रक्तचाप जोखिम", "medium",
         ...
         "লবণ খাওয়া কমান এবং মানসিক চাপ এড়ান।",
        ...
        ("Heat Stroke", "হিট স্ট্রোক", "लू लगना (हीट स्ट्रोक)", "high",
         ...
         "ঠান্ডা জায়গায় যান এবং শরীর ঠান্ডা করুন।",
    ...
    linkages = [
        ...
        ("Urinary Tract Infection", ["Fever", "Frequent urination", "Painful urination", "Blood in urine"]),
...
def seed_doctors(cursor):
    ...
    doctors = [
        ("Dr. Arindam Mukherjee", "Cardiologist",
         ...
         json.dumps(["10:00", "11:00", "16:00", "17:00"]),
         "+91 98300 12345", "en"),
        ("Dr. Shampa Chatterjee", "General Physician",
         json.dumps(["Tue", "Thu", "Sat"]),
         json.dumps(["09:00", "10:30", "14:00", "15:30"]),
         "+91 98310 23456", "bn"),
        ("Dr. Rajesh Gupta", "Pediatrician",
         json.dumps(["Mon", "Tue", "Thu"]),
         json.dumps(["11:00", "12:00", "18:00", "19:00"]),
         "+91 98360 34567", "hi"),
        ("Dr. Ananya Das", "Dermatologist",
         json.dumps(["Wed", "Fri", "Sat"]),
         json.dumps(["10:00", "11:30", "16:30", "18:00"]),
         "+91 98320 45678", "en"),
        ("Dr. Somenath Banerjee", "Neurologist",
         json.dumps(["Mon", "Wed", "Sat"]),
         json.dumps(["12:00", "13:00", "17:00", "18:30"]),
         "+91 98330 56789", "bn"),
    ]
...
def seed_medicines(cursor):
    """Seed OTC medicines for each condition and link to Jan Aushadhi facilities."""
    # Delete old mappings and refresh from strict rules
    ...
    medicines = [
        # Eye conditions
        ("Conjunctivitis", "Sodium Chloride Eye Drops", "সোডিয়াম ক্লোরাইড আই ড্রপ", "सोडियम क्लोराइड आई ड्रॉप", 1),
        ("Conjunctivitis", "Chloramphenicol Eye Drops", "ক্লোরামফেনিকল আই ড্রপ", "क्लोरामफेनिकोल आई ड्रॉप", 1),
        ("Conjunctivitis (Pink Eye)", "Sodium Chloride Eye Drops", "সোডিয়াম ক্লোরাইড আই ড্রপ", "सोडियम क्लोराइड आई ड्रॉप", 1),
        ("Conjunctivitis (Pink Eye)", "Chloramphenicol Eye Drops", "ক্লোরামফেনিকল আই ড্রপ", "क्लोरामफेनिकोल आई ड्रॉप", 1),

        # Ear conditions
        ("Ear Infection", "Otocain Ear Drops", "ওটোকেইন ইয়ার ড্রপ", "ओटोकैन ईयर ड्रॉप", 1),
        ("Ear Infection", "Paracetamol", "প্যারাসিটামল", "पैरासिटामोल", 1),

        # Skin/fungal
        ("Skin Allergy", "Clotrimazole Cream", "ক্লোট্রিমাজল ক্রিম", "क्लोट्रिमाज़ोल क्रीम", 1),
        ("Skin Allergy", "Calamine Lotion", "ক্যালামাইন লোশন", "कैलामाइन लोशन", 1),
        ("Skin Allergy", "Hydrocortisone Cream", "হাইড্রোকর্টিসোন ক্রিম", "हाइड्रोकार्टिसोन क्रीम", 1),
        ("Scabies", "Clotrimazole Cream", "ক্লোট্রিমাজল ক্রিম", "क्लोट्रिमाज़ोल क्रीम", 1),
        ("Scabies", "Calamine Lotion", "ক্যালামাইন লোশন", "कैलामाइन लोशन", 1),
        ("Scabies", "Hydrocortisone Cream", "হাইড্রোকর্টিসোন ক্রিম", "हाइड्रोकार्टिसोन क्रीम", 1),

        # Allergy/rash
        ("Skin Allergy", "Cetirizine", "সেটিরিজিন", "सेटिरिज़ीन", 1),
        ("Skin Allergy", "Calamine Lotion", "ক্যালামাইন লোশন", "कैलामाइन लोशन", 1),
        ("Skin Allergy", "Loratadine", "লোরাটাডাইন", "लॉरटाडिन", 1),

        # Cough/cold
        ("Common Cold", "Guaifenesin Syrup", "গুফেনেসিন সিরাপ", "गुइफ़ेनेसिन सिरप", 1),
        ("Common Cold", "Dextromethorphan Syrup", "ডেক্সট্রোমেথোরফান সিরাপ", "डेक्स्ट्रोमेथोर्फ़ान सिरप", 1),
        ("Common Cold", "Cetirizine", "সেটিরিজিন", "सेटिरिज़ीन", 1),
        ("Common Cold", "Vitamin C 500mg", "ভিটামিন সি ৫০০মিগ্রা", "विटामिन सी ५००मिग्राम", 1),
        ("Influenza", "Guaifenesin Syrup", "গুফেনেসিন সিরাপ", "गुइफ़ेनेसिन सिरप", 1),
        ("Influenza", "Dextromethorphan Syrup", "ডেক্সট্রোমেথোরফান সিরাপ", "डेक्स्ट्रोमेथोर्फ़ान सिरप", 1),
        ("Influenza", "Cetirizine", "সেটিরিজিন", "सेटिरिज़ीन", 1),
        ("Influenza", "Vitamin C 500mg", "ভিটামিন সি ৫০০মিগ্রা", "विटामिन सी ५००मिग्राम", 1),
        ("Chest Infection", "Guaifenesin Syrup", "গুফেনেসিন সিরাপ", "गुइफ़ेनेसिन सिरप", 1),
        ("Chest Infection", "Dextromethorphan Syrup", "ডেক্সট্রোমেথোরফান সিরাপ", "डेक्स्ट्रोमेथोर्फ़ान सिरप", 1),
        ("Chest Infection", "Cetirizine", "সেটিরিজিন", "सेटिरिज़ीन", 1),
        ("Chest Infection", "Vitamin C 500mg", "ভিটামিন সি ৫০০মিগ্রা", "विटामिन सी ५००मिग्राम", 1),
        ...
        ("Food Poisoning", "Antacid (Gelusil)", "অ্যান্টাসিড (জেলুসিল)", "एंटासिड (जेलुसिल)", 1),
        ("Food Poisoning", "Domperidone", "ডমপেরিডন", "डोम्पेरिडोन", 1),
        ("Food Poisoning", "Loperamide", "লোপেরামাইড", "लोपरामाइड", 1),
        ("Food Poisoning", "Zinc Sulfate", "জিঙ্ক সালফেট", "जिंक सल्फेट", 1),
        ("Gastroenteritis", "ORS (Oral Rehydration Salts)", "ওআরএস", "ओआरएस", 1),
        ("Gastroenteritis", "Antacid (Gelusil)", "অ্যান্টাসিড (জেলুসিল)", "एंटासिड (जेलुसिल)", 1),
        ("Gastroenteritis", "Domperidone", "ডমপেরিডন", "डोम्पेरिडोन", 1),
        ("Gastroenteritis", "Loperamide", "লোপেরামাইড", "लोपरामाइड", 1),
        ("Gastroenteritis", "Zinc Sulfate", "জিঙ্ক সালফেট", "जिंक सल्फेट", 1),
        ...
        ("Malaria Risk", "ORS (Oral Rehydration Salts)", "ওআরএস", "ओआरएस", 1),
        ("Typhoid Risk", "Paracetamol", "প্যারাসিটামल", "पैरासिटामोल", 1),
        ("Typhoid Risk", "ORS (Oral Rehydration Salts)", "ওআরএস", "ओआरएस", 1),
        ("Heat Stroke", "Paracetamol", "প্যারাসিটামল", "पैरासिटामोल", 1),
        ("Heat Stroke", "ORS (Oral Rehydration Salts)", "ওআরএস", "ओआरएस", 1),
        ("Heat Stroke", "Electrolyte Powder", "ইলেক্ট্রোলাইট পাউডার", "इलेक्ट्रोलाइट पाउडर", 1),

        # UTI
        ("Urinary Tract Infection", "Potassium Citrate", "পটাসিয়াম সিট্রেট", "पोटेशियम साइट्रेट", 1),
        ("Urinary Tract Infection", "Cranberry Extract Tablets", "ক্র্যানবেরি ট্যাবলেট", "क्रैनबेरी टैबलेट", 1),

        # Throat
        ("Common Cold", "Povidone Iodine Gargle", "পোভিডোন আইডিন গার্গল", "पोविडोन आयोडीन गरारे", 1),
        ("Common Cold", "Strepsils", "স্ট্রেপসিলস", "स्ट्रेप्सिल्स", 1),
        ("Influenza", "Povidone Iodine Gargle", "পোভিডোন আইডিন গার্গল", "पोविडोन आयोडीन गरारे", 1),
        ("Influenza", "Strepsils", "স্ট্রেপসিলস", "स्ट्रेप्सिल्स", 1),

        # Other conditions
        ("Jaundice Risk", "Vitamin C 500mg", "ভিটামিন সি ৫০০মিগ্রা", "विटामिन सी ५००मिग्राम", 1),
        ("Anaemia", "Iron + Folic Acid Tablets", "আয়রন + ফলিক অ্যাসিড ট্যাবলেট", "आयरन + फोलिक एसिड टैबलेट", 1),
        ("Anaemia", "Vitamin C 500mg", "ভিটামিন সি ৫০০মিগ্রা", "विटामिन सी ५००मिग्राम", 1),
        ("Hypertension Risk", "Vitamin C 500mg", "ভিটামিন সি ৫০০মিগ্রা", "विटामिन सी ५००मिग्राम", 1),
    ]
    ...
    for cond_name, name_en, name_bn, name_hi, otc in medicines:
        ...
        if not c_id:
            continue
        cursor.execute("""
            INSERT OR IGNORE INTO medicines (condition_id, name_en, name_bn, name_hi, otc_available)
            VALUES (?, ?, ?, ?, ?)
        """, (c_id, name_en, name_bn, name_hi, otc))

        cursor.execute("SELECT medicine_id FROM medicines WHERE condition_id = ? AND name_en = ?", (c_id, name_en))
        row = cursor.fetchone()
        if row:
            med_ids.append(row['medicine_id'])

    # Link medicines to Jan Aushadhi / pharmacy facilities
...
def refresh_medicine_seed(cursor):
    """Backfill OTC medicines for conditions with no medicine mappings."""
    cursor.execute("SELECT condition_id FROM conditions")
    all_cond_ids = {row['condition_id'] for row in cursor.fetchall()}

    cursor.execute("SELECT DISTINCT condition_id FROM medicines")
    existing_cond_ids = {row['condition_id'] for row in cursor.fetchall()}

    missing_cond_ids = all_cond_ids - existing_cond_ids
    if not missing_cond_ids:
        return

    cursor.execute("SELECT condition_id, name_en FROM conditions")
    cond_name_map = {row['condition_id']: row['name_en'] for row in cursor.fetchall()}

    quick_mapping = {
        'Common Cold': ['Paracetamol', 'Cetirizine', 'Guaifenesin Syrup'],
        'Influenza': ['Paracetamol', 'Ibuprofen', 'ORS (Oral Rehydration Salts)'],
        'Dengue Risk': ['Paracetamol', 'ORS (Oral Rehydration Salts)'],
        'Malaria Risk': ['Paracetamol', 'ORS (Oral Rehydration Salts)'],
        'Dehydration': ['ORS (Oral Rehydration Salts)', 'Electrolyte Powder'],
        'Food Poisoning': ['ORS (Oral Rehydration Salts)', 'Activated Charcoal', 'Domperidone'],
        'Typhoid Risk': ['Paracetamol', 'ORS (Oral Rehydration Salts)'],
        ...
        'Chest Infection': ['Guaifenesin Syrup', 'Paracetamol'],
        'Asthma Attack': ['Salbutamol Inhaler'],
        'Urinary Tract Infection': ['Potassium Citrate', 'Cranberry Extract Tablets'],
        'Jaundice Risk': ['ORS (Oral Rehydration Salts)', 'Vitamin C 500mg'],
        'Anaemia': ['Iron + Folic Acid Tablets', 'Vitamin C 500mg'],
        'Skin Allergy': ['Cetirizine', 'Calamine Lotion'],
        'Gastroenteritis': ['ORS (Oral Rehydration Salts)', 'Loperamide', 'Zinc Sulfate'],
        'Hypertension Risk': ['Paracetamol', 'Vitamin C 500mg'],
        'Heat Stroke': ['ORS (Oral Rehydration Salts)', 'Electrolyte Powder', 'Paracetamol'],
        'Chickenpox Risk': ['Calamine Lotion', 'Paracetamol'],
        'Anaemia Risk': ['Iron + Folic Acid Tablets', 'Vitamin C 500mg'],
    }

    for c_id in missing_cond_ids:
        c_name = cond_name_map.get(c_id, '')
        names = quick_mapping.get(c_name, ['Paracetamol', 'ORS (Oral Rehydration Salts)'])
        for name in names:
            # Attempt to use consistent localised labels when possible.
            if name == 'Paracetamol':
                name_bn, name_hi = 'প্যারাসিটামল', 'पैरासिटामोल'
            elif name == 'ORS (Oral Rehydration Salts)':
                name_bn, name_hi = 'ওআরএস', 'ओआरएस'
            else:
                name_bn, name_hi = name, name

            cursor.execute("INSERT OR IGNORE INTO medicines (condition_id, name_en, name_bn, name_hi, otc_available) VALUES (?, ?, ?, ?, 1)",
                           (c_id, name, name_bn, name_hi))

    # Ensure linked with pharma facilities for newly added meds
    cursor.execute("SELECT facility_id FROM facilities WHERE type IN ('Jan Aushadhi', 'Pharmacy')")
    pharma_facilities = [row['facility_id'] for row in cursor.fetchall()]

    cursor.execute("SELECT medicine_id FROM medicines WHERE condition_id IN ({})".format(','.join('?' * len(missing_cond_ids))), tuple(missing_cond_ids))
    new_med_ids = [row['medicine_id'] for row in cursor.fetchall()]
